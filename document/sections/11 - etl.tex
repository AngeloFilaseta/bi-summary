...
\subsection{Risulti dell'estrazione}
...
Ogni problema richiede una tecnica specifica per la soluzione. Il corso di Sistemi Informativi ha già approfondito questi aspetti, quindi qua vengono solo riassunti:
